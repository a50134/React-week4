function ProductModal({modalType,templateProduct,handleModalInputChange,handleModalImageChange,handleAddImage,handleRemoveImage,updateProduct,deleteProduct,uploadImage,closeModal}) {
    return(
        ...
        <div className="modal-dialog modal-xl">
          <div className="modal-content border-0">
            ...
            <div className="modal-footer">
              {
                modalType === 'delete' ?(
                  <button type="button" className="btn btn-danger" onClick={() =>deleteProduct(templateProduct.id)}>刪除</button>
                ):(
                  <>
